#########################################################
#########################################################
######## INTERNSHIP PROJECT - plots TOP proteins ########
#########################################################
#########################################################
...
table(PGS002013_df$risk_gr_clrt_cncr_PGS_restr_70)
table(PGS002013_df$risk_gr_clrt_cncr_PGS_restr_30)
...
if(is.null(crc_df)){
  ...
  ggsave("heatmap_notshared_prots.tiff", plot = heatmap_plot, width = 20, height = 16, dpi = 300)
  ...
  ggsave("heatmap_shared_prots.tiff", plot = heatmap_plot_shared, width = 12, height = 6, dpi = 300)
  ...
  ggsave("heatmap_shared_2grs_prots.tiff", plot = heatmap_plot_shared_2grs, width = 20, height = 16, dpi = 300)
}
